package com.amg.android.projectt.client;
...
public class ImgurClient {
    ...
    private static final String IMGUR_GALLERY_V3_TOP_SEARCH_URI = "/3/gallery/search/top";
    private static final String IMGUR_GALLERY_SEARCH_QUERY_KEY = "q";
    ...
    public void searchGallery(final String search, final ImgurClientInterface callback){

        ImgurStringRequest request =new ImgurStringRequest(Request.Method.GET, buildSearchUrl(search),
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String string) {
                        ...
                        try {
                            ...
                            Log.e(TAG,"Error parsing Imgur Detail (missing fields): " + search, e);
            ...
            public void onErrorResponse(VolleyError e) {
                Log.e(TAG, "Volley Error fetching Imgur Search:" + search , e);
                callback.onPostExecute(false);
            }
    ...
    private String buildSearchUrl(String search){
        Uri.Builder builder = Uri.parse(IMGUR_PATH).buildUpon();
        builder.path(IMGUR_GALLERY_V3_TOP_SEARCH_URI);
        builder.appendQueryParameter(IMGUR_GALLERY_SEARCH_QUERY_KEY,search);
